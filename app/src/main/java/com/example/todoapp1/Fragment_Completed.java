...
public class Fragment_Completed extends Fragment implements Class_Interface {
    ...
    String Color_Value;
    ArrayList<String> task_id, task_title, task_details, task_date, task_done,task_color;
    ...
    public void onResume() {
        ...
        adapter_completed = new Class_Completed_Adapter(getContext(), task_id, task_title, task_date, task_done, task_details,task_color, this);
    ...
    void uncomplete(int position){
        ...
        String Color_value = (task_color.get(position));
        ...
        add_db.p_add_task(txt_taskTitle.toString().trim(), txt_taskCreationDate.toString().trim(), modified.toString().trim(), txt_taskDetail.toString().trim(),Color_value.toString().trim());
    }
}